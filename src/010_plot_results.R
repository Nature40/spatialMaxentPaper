#'@name 090_plot_results.R
#'@author Lisa Bald [bald@staff.uni-marburg.de]
#'@description RESULT PLOTS FOR MAXENT AND NCEAS
...
data= read.csv(file.path(envrmt$output,"NSW_results_all_folds.csv"))
...
listFiles = list.files(file.path(envrmt$output),pattern = "_results_all_folds.csv", recursive=T)
...
write.csv(results, file.path(envrmt$output,"count_best_method.csv"))
