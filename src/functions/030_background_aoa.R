...
for (region in regions) {
  ...
  if(!file.exists(paste0("../AOA/",region,"_aoa_random.tif"))){
    ...
    terra::writeRaster(AOA, paste0("../AOA/",region,"_aoa_lhs.tif"))
  }
  ...
  if(!file.exists(paste0("../AOA/",region,"_aoa_random.tif"))){
    ...
    stopCluster(cl)
    terra::writeRaster(AOA, paste0("../AOA/",region,"_aoa_random.tif"))
